...
const Sidebar = () => {
  ...
  return (
    <aside className="w-56 shrink-0 min-h-[calc(100vh-57px)] bg-white border-r border-gray-200 py-4 flex flex-col">
        ...
        {navItems.map(({ to, label, action }) => {
          ...
          return (
            <NavLink
              ...
              to={to}
              className={({ isActive }) =>
                `block px-3 py-2 rounded-md text-[13.5px] font-semibold transition-colors ${
                  isActive
